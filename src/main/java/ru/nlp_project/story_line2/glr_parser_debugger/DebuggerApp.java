...
public class DebuggerApp extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		URL fxml = Thread.currentThread().getContextClassLoader()
				.getResource("ru/nlp_project/story_line2/glr_parser_debugger/fxml/mainForm.fxml");
	...
	public void analyse(File dirFile) {
		...
		try {
			glrParser = GLRParser.newInstance(dirFile.getAbsolutePath() + "/glr-config.json",
